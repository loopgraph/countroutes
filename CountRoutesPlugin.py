...
from .CountRoutesMethods import CountRoutesMethods
...
class CountRoutesPlugin:
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('CountRoutes', message)
    ...
    def initGui(self):
        ...
        # Init processing
        self.provider = CountRoutesProvider(
            providerIconPath, 
            bqIconPath, 
            CountRoutesMethods(), 
            BottleneckQuestAlgorithm
        )
        QgsApplication.instance().processingRegistry().addProvider(self.provider)
